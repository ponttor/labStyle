...
export default function Element({ title, description, number }) {
  return (
    <div className="card shadow-sm x-shadow-fade-in bg-white d-flex flex-row mb-4 " style={{ width: '35rem' }}>
      <div className="d-flex align-items-center justify-content-center">
        {/* <img src={kinematic} className="img-fluent" style={{ height: '11rem' }} /> */}
      </div>
      {/* <div className="col position-static"> */}
      <div className="container">
        <div className="row my-2">
          <div className="col-1 text-center"><h3>{number}</h3></div>
          <div className="col">
